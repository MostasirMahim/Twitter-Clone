      ...
      <div>
        ...
        {post.comments.map((comment) => {
          return (
            <div
              key={comment._id}
              className="border-b-[1px] border-gray-700 pl-16"
            >
              <div className="flex flex-start items-center w-full">
                ...
                <div
                  ...
                  className="flex-col items-center pb-2 w-full ml-2"
                >
                  <span className=" flex justify-start items-center space-x-2 mt-2 cursor-pointer ">
                    <h1 className="hover:text-sky-400 font-semibold">
                      {comment.user.fullname}
                    </h1>
                    <h1 className="hover:text-sky-400 italic">
